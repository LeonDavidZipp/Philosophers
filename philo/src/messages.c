...
/*   Updated: 2024/02/08 12:37:35 by lzipp            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../inc/philo.h"

void	fork_message(long long ms, int id, t_routine *r)
{
	bool	some_died;
...
void	eat_message(long long ms, int id, t_routine *r)
{
	bool	some_died;
...
void	sleep_message(long long ms, int id, t_routine *r)
{
	bool	some_died;
...
void	think_message(long long ms, int id, t_routine *r)
{
	bool	some_died;
...
void	death_message(long long ms, int id, t_routine *r)
{
	bool	some_died;
